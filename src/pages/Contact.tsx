    ...
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="border border-black/10 rounded-xl p-6 bg-white space-y-4">
          <h2 className="text-xl font-bold text-[#215E99]">Contact Details</h2>
          <div className="space-y-3 text-sm text-black">
            ...
            <div>
              ...
              <a href="tel:01024526724" className="text-[#215E99] font-medium hover:underline">
                01024526724
              </a>
            </div>
            <div>
              <p className="font-semibold text-black/60">Email</p>
              <a href="mailto:amrgamil300@gmail.com" className="text-[#215E99] font-medium hover:underline">
        ...
        <form className="border border-black/10 rounded-xl p-6 bg-white space-y-4" onSubmit={(e) => e.preventDefault()}>
          <h2 className="text-xl font-bold text-[#215E99]">Send a Message</h2>
          <div>
            ...
            <input
              type="text"
              id="name"
              className="w-full border border-black/20 rounded-md p-2 text-sm focus:outline-none focus:border-[#215E99]"
          ...
          <button
            type="submit"
            className="w-full bg-[#215E99] text-white font-bold py-2 rounded-md hover:opacity-90 transition-opacity text-sm"
          >
            Submit Message
          </button>
        </form>
